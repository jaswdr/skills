...
2. Pick the skills you want, and which coding agents you want to install them on. **Make sure you select `/setup-jaswdr-skills`**.

3. Run `/setup-jaswdr-skills` in your agent. It will:
