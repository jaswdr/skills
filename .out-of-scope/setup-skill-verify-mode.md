# Verify/Check Mode for `setup-jaswdr-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-jaswdr-skills`.
...
- #106 — Feature request: verify/check mode for setup-jaswdr-skills
